...
#-----------------------------------------------
ggbox <- function(gdf, mode="g", show_marker=FALSE, marker_size=5, text_angle=25) {
    ...
    g <- g  + geom_text(aes(x=xx_grad, y=1, label=fmt_c1(amt_grad), fill=fill_grad), position=position_stack(vjust=0.5), color='white', stat="identity");
